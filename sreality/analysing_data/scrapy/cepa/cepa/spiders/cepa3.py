...
def writetoCSV(arg1, arg2, arg3, arg4, arg5):
    ...
    df = pd.DataFrame(fe)
    if(not os.path.exists("/home/jm/Documents/master_new_repo/code_data/analysing_data/R/CSVs/df3.csv")):
        df.to_csv("/home/jm/Documents/master_new_repo/code_data/analysing_data/R/CSVs/df3.csv", mode="a", sep=",", na_rep="NA",  index=False, header = ['prop_id', 'req_url', 'lat', 'lon', 'esti_price_sq_meter'])
    else:
        df.to_csv("/home/jm/Documents/master_new_repo/code_data/analysing_data/R/CSVs/df3.csv", mode="a", sep=",", na_rep="NA",  index=False,header=False)

def extractInfo():
    with open('/home/jm/Documents/master_new_repo/code_data/analysing_data/R/CSVs/id_lot_lat3.csv') as csvfile:
        readCSV = csv.DictReader(csvfile)
        str_beg = 'http://cenovamapa.eu/?do=getprice&p=('
        str_end = ')&zoom=12&t=domy-prodej' # <-------------- DONT FORGET TO CHANGE HERE AS WELL: byty-najem, byty-prodej, domy-prodej
