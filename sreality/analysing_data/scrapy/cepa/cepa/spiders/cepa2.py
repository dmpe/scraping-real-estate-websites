...
def extractInfo():
    with open('/home/jm/Documents/master_new_repo/code_data/analysing_data/R/CSVs/id_lot_lat2.csv') as csvfile:
        readCSV = csv.DictReader(csvfile)
        str_beg = 'http://cenovamapa.eu/?do=getprice&p=('
        str_end = ')&zoom=12&t=byty-najem' # <-------------- DONT FORGET TO CHANGE HERE AS WELL: byty-najem, byty-prodej, domy-prodej
